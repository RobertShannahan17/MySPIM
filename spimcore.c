...
// Initializes register elements to 0 and PC, SP, and GP register addresses
// to initial point
void Init(void)
{
...
// Writes control signal addresses to file
...
void Loop(void)
{
	...
	// Switch case for different debug options
	for (;;)
	{
		fprintf(stdout, "\n%s cmd: ", Redir);
		Buf[0] = '\0';
...
int main(int argc, char **argv)
{
	...
	{
	    // Error check file open and read
	...
	// This is where the actual operation begins
	Loop();
